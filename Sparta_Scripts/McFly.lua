...
function McFlyIndex:savePoint()
	...
	print("McFly:savePoint: stack size is "..#self.matrixStack)
end
...
function McFlyIndex:reset()
	...
	self.matrixStack = {}
	self:savePoint()
	print("McFly:reset: stack size is "..#self.matrixStack)
end

function McFlyIndex:goBack(steps)
	if steps > 0 and steps < #self.matrixStack then
