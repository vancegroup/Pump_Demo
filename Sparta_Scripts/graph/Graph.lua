...
function GraphPrototype:getEdge(srcname, destname)
	...
	print("Graph:getEdge - Edge Not Found(src = "..srcname..",dest = "..destname)
	return nil
...
function GraphPrototype:addEdges(edges)
	for _, edge in ipairs(edges) do
		if not self:edgeExists(edge) then
			...
			assert(self.nodes[edge.srcname], "Graph:addEdges - Source name of edge unknown!"..edge.srcname..")")
			edge.src = self.nodes[edge.srcname]

			assert(self.nodes[edge.destname], "Graph:addEdges - Destination name of edge unknown! ("..edge.destname..")")
